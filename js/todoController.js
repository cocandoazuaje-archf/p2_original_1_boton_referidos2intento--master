angular
  ...
  .controller(
    "TodoController",
    function (
      VerificaReferenciaActiva,
      Sucursales,
      Canales,
      RolesUsuarios,
      ExportarDatatable,
      DerivarMasivo,
      ImportarRolesUsuarios,
      ImportarSucursalesEjecutivos,
      ImportarSucursales,
      ExportarReferidos,
      RolesUsuariosNombre,
      ActualizarReferidosSi,
      ActualizarReferidosNo,
      ImportarReferidos,
      ReferenciasReagendadasFull,
      Referidos,
      PanelTotales,
      Ejecutivos,
      Referencias,
      ReferenciasReagendadas,
      Acciones,
      BitacorasByReferencia,
      Bitacoras,
      ReferenciasNoCerradas,
      $filter,
      $location,
      $http,
      $window,
      ...
      vm.actualizarReferidosSi = function (jsonData, i) {
        ...
        actualizarReferidos.$save(
          ...
          function (err) {
            ...
            toastr.error(
              "Ha ocurrido un problema al actualizar el referido -> " +
                actualizarReferidos.NOMBRE,
      ...
      vm.importarReferidos22 = function (jsonData, vengoDeLaFicha) {
        ...
        if (!vengoDeLaFicha) {
          angular.forEach(jsonData, function (d) {
            d.FECHA_RECEPCION = new Date(
              (d.FECHA_RECEPCION - (25567 + 1)) * 86400 * 1000,
            );
        ...
        $http({
          ...
          function (res) {
            ...
            if (vm.ErrorCrearReferidoReferenciaBitacoraOut.length > 0) {
              vm.exportarErrorCrearReferidoReferenciaBitacora(
                vm.ErrorCrearReferidoReferenciaBitacoraOut,
              );
            }
            vm.mostrarLoading = false;
            vm.mostrarContactos();
          ...
          function (err) {
            ...
            vm.mostrarLoading = false;
            toastr.error(
              "Ha ocurrido un problema al importar referidos.",
              " " + err.status + " " + err.statusText,
            );
          },
        );
      ...
      vm.importarEjecutivos2 = function (jsonData) {
        ...
        $http({
          ...
          function (err) {
            ...
            vm.mostrarLoading = false;
            toastr.error(
              "Ha ocurrido un problema al importar los ejecutivos.",
              " " + err.status + " " + err.statusText,
            );
          },
        );
      ...
      vm.importarSucursales2 = function (jsonData) {
        ...
        $http({
          ...
          function (err) {
            ...
            vm.mostrarLoading = false;
            toastr.error(
              "Ha ocurrido un problema al importar las sucursales.",
              " " + err.status + " " + err.statusText,
            );
          },
        );
      ...
      vm.importarSucursales = function (jsonData, i) {
        ...
        importarSucursales.$save(
          ...
          function (res) {
            toastr.success(
              "Se ha creado la sucursal con exito -> " + jsonData[i].SUCURSAL,
              " Ok",
            );
          ...
          function (err) {
            vm.mostrarLoading = false;
            toastr.error(
              "No Se ha creado la sucursal con exito -> " +
                jsonData[i].SUCURSAL,
              " " + err.status + " " + err.statusText,
            );
            i++;
      ...
      vm.exportarErrorCrearSucursales = function (xlsRows) {
        ...
        /* File Name */
        var filename =
          "Error_CrearSucursales_" +
          $filter("date")(new Date(), "medium") +
          ".xlsx";
      ...
      vm.exportarErrorCrearReferidoReferenciaBitacora = function (xlsRows) {
        ...
        /* File Name */
        var filename =
          "Error_CrearReferidoReferenciaBitacora_" +
          $filter("date")(new Date(), "medium") +
          ".xlsx";
      ...
      vm.importarReferidos2 = function (jsonData, i) {
        ...
        referidos.FECHANAC =
          jsonData[i].fechanac != undefined ? jsonData[i].fechanac : null;
        ...
        if (jsonData[i].RUT_1 == undefined) {
          if (jsonData[i].RUT == undefined || jsonData[i].RUT.length < 7) {
            ...
            referidos.RUT =
              jsonData[i].RUT != " "
                ? jsonData[i].RUT
                : "SR" + new Date().getTime().toString().substr(5, 8);
          }
        } else {
        ...
        referidos.$save(
          ...
          function (res) {
            toastr.success(
              "Se ha creado el referido con exito el referido -> " +
                jsonData[i].NOMBRE,
              " Ok",
            );
          ...
          function (err) {
            ...
            toastr.error(
              "No se ha cargado el referido -> " + jsonData[i].NOMBRE,
              " " + err.status + " " + err.statusText,
            );
      ...
      vm.descargarPlantillaReferenciasActualizar = function () {
        ...
        /* File Name */
        var filename =
          "Formato de actualizar datos Referencias_" +
          $filter("date")(new Date(), "medium") +
          ".xlsx";
      ...
      vm.descargarPlantillaCargarLosNo = function () {
        ...
        /* XLS Head Columns */
        var xlsHeader = ["Id", "Conecta_Noconecta", "COMENTARIOS"];
        ...
        /* File Name */
        var filename =
          "Formato para cargar los NO del Genesis_" +
          $filter("date")(new Date(), "medium") +
          ".xlsx";
      ...
      vm.descargarPlantillaCargarLosRoles = function () {
        ...
        /* XLS Head Columns */
        var xlsHeader = ["NOMBRE", "ROL", "AST", "SUP"];
        ...
        /* File Name */
        var filename =
          "Formato para cargar los Roles de Usuarios_" +
          $filter("date")(new Date(), "medium") +
          ".xlsx";
      ...
      vm.descargarPlantillaCargarEjecutivas = function () {
        ...
        /* File Name */
        var filename =
          "Formato para cargar las Ejecutivas_" +
          $filter("date")(new Date(), "medium") +
          ".xlsx";
      ...
      vm.descargarPlantillaCargarSucursales = function () {
        ...
        /* File Name */
        var filename =
          "Formato para cargar las Sucursales_" +
          $filter("date")(new Date(), "medium") +
          ".xlsx";
      ...
      vm.descargarPlantillaCargarLosSi = function () {
        ...
        /* XLS Head Columns */
        var xlsHeader = ["ID", "Observaciones"];
        ...
        /* File Name */
        var filename =
          "Formato para cargar los SI del Genesis_" +
          $filter("date")(new Date(), "medium") +
          ".xlsx";
      ...
      vm.descargarPlantillaReferenciasCargaInicial = function () {
        ...
        /* File Name */
        var filename =
          "Formato de carga de Referidos_" +
          $filter("date")(new Date(), "medium") +
          ".xlsx";
      ...
      vm.descargarPlantillaReferidosDatosPersonales = function () {
        ...
        /* File Name */
        var filename =
          "Formato de carga para actualizar datos Personales de Referidos_" +
          $filter("date")(new Date(), "medium") +
          ".xlsx";
      ...
      vm.fExportarDatatablPantEje = function (opDatos) {
        ...
        vm.continuarExportarDatatablePantEje = function (xlsRows, opDatos) {
          ...
          angular.forEach(xlsRows, function (val) {
            ...
            xlsRows2.push({
              ...
              estado:
                val.fechaAccionFormat == undefined
                  ? val.accionId.nombre
                  : val.accionId.nombre + " -> " + val.fechaAccionFormat,
              fechaAccion: val.fechaAccion
                ? $filter("date")(val.fechaAccion, "dd-MM-yyyy")
                : "",
          ...
          if (opDatos == 1) {
            /* File Name */
            var filename =
              "ListaDeTareas_Exportados_por_ejecutiva_" +
              vm.usuario +
              " " +
              $filter("date")(new Date(), "medium") +
              ".xlsx";
          ...
          if (opDatos == 2) {
            /* File Name */
            var filename =
              "HistoricoTodo_Exportados_por_ejecutiva_" +
              vm.usuario +
              " " +
              $filter("date")(new Date(), "medium") +
              ".xlsx";
          ...
          if (opDatos == 3) {
            /* File Name */
            var filename =
              "ReagendadosHoy_Exportados_por_ejecutiva_" +
              vm.usuario +
              " " +
              $filter("date")(new Date(), "medium") +
              ".xlsx";
          ...
          if (opDatos == 4) {
            /* File Name */
            var filename =
              "ReagendadosTodo_Exportados_por_ejecutiva_" +
              vm.usuario +
              " " +
              $filter("date")(new Date(), "medium") +
              ".xlsx";
        ...
        if (opDatos == 4) {
          res = $filter("filter")(
            vm.ReferenciasReagendadasTodoEje,
            vm.filtroReferenciasReagendadasTodoEje,
          );
      ...
      vm.fExportarDatatable = function () {
        ...
        vm.continuarExportarDatatable = function (xlsRows) {
          ...
          angular.forEach(xlsRows, function (val) {
            ...
            xlsRows2.push({
              ...
              FECHANAC: val.FECHANAC
                ? $filter("date")(val.FECHANAC, "dd-MM-yyyy")
                : "",
              rut: val.rut,
              correo: val.correo,
              afp: val.afp,
          ...
          /* File Name */
          var filename =
            "Referidos_Exportados_de_tabla_" +
            $filter("date")(new Date(), "medium") +
            ".xlsx";
        ...
        ExportarDatatable.list(
          ...
          function (err) {
            vm.mostrarLoading = false;
            toastr.error(
              "No se ha cargado referidos para exportar. " +
                err.status +
                " " +
                err.statusText,
            );
      ...
      vm.fExportarDatatableParaFicha = function () {
        ...
        vm.continuarExportarDatatableParaFicha = function (xlsRows) {
          ...
          angular.forEach(xlsRows, function (val) {
            ...
            xlsRows2.push({
              ...
              fechanac: val.FECHANAC
                ? $filter("date")(val.FECHANAC, "dd-MM-yyyy")
                : "",
              fecharecepcion: val.fecha
                ? $filter("date")(val.fecha, "dd-MM-yyyy")
                : "",
              fechaFicha: val.fechaFicha
                ? $filter("date")(val.fechaFicha, "dd-MM-yyyy")
                : "",
              rut: val.rut,
              ...
              canal: val.canal,
              encDigitalResp1:
                val.encDigitalPreg1 == null
                  ? ""
                  : val.encDigitalResp1 == 0
                    ? "NO"
                    : "SI",
              encDigitalResp2:
                val.encDigitalPreg2 == null
                  ? ""
                  : val.encDigitalResp2 == 0
                    ? "NO"
                    : "SI",
              encDigitalResp3:
                val.encDigitalPreg3 == null
                  ? ""
                  : val.encDigitalResp3 == 0
                    ? "NO"
                    : "SI",
              encDigitalResp4:
                val.encDigitalPreg4 == null
                  ? ""
                  : $filter("date")(val.encDigitalResp4, "dd-MM-yyyy"),
            });
          });
          ...
          var xlsHeader = [
            ...
            "Afp",
            "Prima",
            "¿Cómo supo que podía pensionarse en Consorcio?",
            "Para quien fue la atención ?",
            "¿Qué acción realizó con el cliente ? ",
            "Tipo de Pensión ?",
            "Sexo Pensionable",
            "Canal",
            "¿Tienes un Certificado de Saldo? ",
            "¿Haz realizado Solicitud de Oferta Anónima (SOA)?",
        ...
        vm.continuarExportar = function (xlsRows) {
          ...
          angular.forEach(xlsRows, function (val) {
            xlsRows2.push({
              ...
              NOMBRE_COMPLETO:
                val.referidoId.apellido != undefined
                  ? val.referidoId.nombre + " " + val.referidoId.apellido
                  : val.referidoId.nombre,
              Rut:
                val.referidoId.rut.substr(0, 2) == "SR"
                  ? val.referidoId.rut
                  : val.referidoId.rut,
              TELEONO1: val.referidoId.telefonos
                ? val.referidoId.telefonos
                : "",
              TELEONO2: val.referidoId.telefonos2
                ? val.referidoId.telefonos2
                : "",
              TELEONO3: val.referidoId.telefonos3
                ? val.referidoId.telefonos3
                : "",
              E_MAIL: val.referidoId.correo ? val.referidoId.correo : "",
              FECHA_RECEPCIÓN: val.fecha
                ? $filter("date")(val.fecha, "dd-MM-yyyy")
                : "",
        ...
        $scope.$apply(function () {
          try {
            ...
            jsonData = XLSX.utils.sheet_to_json(
              newWorkBook.Sheets[first_sheet_name],
            );
            ...
            for (var i = 1; i < jsonData.length; i++) {
              if (
                ...
                $scope.Elements.push(jsonData[i]);
              } else {
                break;
              }
            ...
            toastr.error(
              "Ha ocurrido un problema al cargar el archivo.",
              e.toString(),
            );
          }
        });
      ...
      vm.importarRoles = function (jsonData, i) {
        ...
        rolesUsuarios.$save(
          ...
          function (res) {
            toastr.success(
              "Se ha creado o actualizado el usuario con exito -> " +
                jsonData[i].NOMBRE +
                " - " +
                jsonData[i].ROL,
              " Ok",
      ...
      vm.cargarComentario = function () {
        vm.mensajesPreEstablecidosSelect = JSON.parse(
          vm.mensajesPreEstablecidosSelect,
        );
        ...
        if (vm.mensajesPreEstablecidosSelect.descrip == "OTROS") {
          ...
          vm.messageActividad.comentarios =
            vm.mensajesPreEstablecidosSelect.descrip;
        }
      };
      ...
      vm.cargarAccionesTodos = function () {
        ...
        $http({
          ...
          function (err) {
            vm.mostrarLoading = false;
            toastr.error(
              "Ha ocurrido un problema al cargar todos los Estados.",
              " " + err.status + " " + err.statusText,
            );
          },
        );
      ...
      vm.fichaCanalDigitalSinRespuestas = function () {
        ...
        $http({
          ...
          function (err) {
            vm.mostrarLoading = false;
            toastr.error(
              "Ha ocurrido un problema al cargar las preguntas.",
              " " + err.status + " " + err.statusText,
            );
          },
        );
      ...
      vm.fichaCanalDigitalRespuestas = function () {
        ...
        $http({
          url:
            "/referidosrrvv/webresources/cl.cnsv.referidosrrvv.models.encuesta/rut/" +
            vm.ficha.RUT,
          method: "GET",
          headers: {
            "Content-Type": "application/json; charset=UTF-8;",
      ...
      vm.fichaCanalDigitalBorrar = function () {
        $http({
          ...
          function (err) {
            toastr.error(
              "Ha ocurrido un problema al eliminar las respuestas.",
              " " + err.status + " " + err.statusText,
            );
          },
        );
      ...
      vm.cargarSucursales = function () {
        Sucursales.list(
          ...
          function (err) {
            vm.mostrarLoading = false;
            toastr.error(
              "Ha ocurrido un problema al cargar el catalogo de sucursales.",
              " " + err.status + " " + err.statusText,
            );
      ...
      vm.cargarAccionesEjecutivos = function () {
        ...
        vm.accionSinActividad = Acciones.list(
          ...
          function (err) {
            vm.mostrarLoading = false;
            toastr.error(
              "Ha ocurrido un problema al cargar el catalogo de status para -> 'Sin/Actividad'.",
              " " + err.status + " " + err.statusText,
            );
        ...
        vm.accionInteresado = Acciones.list(
          ...
          function (err) {
            vm.mostrarLoading = false;
            toastr.error(
              "Ha ocurrido un problema al cargar el catalogo de status para -> 'Pendiente'.",
              " " + err.status + " " + err.statusText,
            );
        ...
        vm.accionReagendado = Acciones.list(
          ...
          function (err) {
            vm.mostrarLoading = false;
            toastr.error(
              "Ha ocurrido un problema al cargar el catalogo de status para -> 'Reagendado'.",
              " " + err.status + " " + err.statusText,
            );
        ...
        vm.accionCerradoEnviarMail = Acciones.list(
          ...
          function (err) {
            vm.mostrarLoading = false;
            toastr.error(
              "Ha ocurrido un problema al cargar el catalogo de status para -> 'Cerrado / Envio Mail'.",
              " " + err.status + " " + err.statusText,
            );
        ...
        vm.accionCerradoDerivoEjecutiva = Acciones.list(
          ...
          function (err) {
            vm.mostrarLoading = false;
            toastr.error(
              "Ha ocurrido un problema al cargar el catalogo de status para -> 'Cerrado / Derivar ejecutiva'.",
              " " + err.status + " " + err.statusText,
            );
        ...
        vm.accionCerradoSinExito = Acciones.list(
          ...
          function (err) {
            vm.mostrarLoading = false;
            toastr.error(
              "Ha ocurrido un problema al cargar el catalogo de status para -> 'Cerrado / Sin exito'.",
              " " + err.status + " " + err.statusText,
            );
        ...
        vm.accionCerradoConExito = Acciones.list(
          ...
          function (err) {
            vm.mostrarLoading = false;
            toastr.error(
              "Ha ocurrido un problema al cargar el catalogo de status para -> 'Cerrado / Con exito'.",
              " " + err.status + " " + err.statusText,
            );
        ...
        vm.accionAtendido = Acciones.list(
          ...
          function (err) {
            vm.mostrarLoading = false;
            toastr.error(
              "Ha ocurrido un problema al cargar el catalogo de status para -> 'Atendido'.",
              " " + err.status + " " + err.statusText,
            );
        ...
        Ejecutivos.list(
          ...
          function (err) {
            vm.mostrarLoading = false;
            toastr.error(
              "Ha ocurrido un problema al cargar el catalogo de ejecutivos.",
              " " + err.status + " " + err.statusText,
            );
        ...
        RolesUsuarios.list(
          ...
          function (err) {
            vm.mostrarLoading = false;
            toastr.error(
              "Ha ocurrido un problema al cargar el catalogo de Roles de Usuario.",
              " " + err.status + " " + err.statusText,
            );
      ...
      vm.verificarCheckedCheckbox = function (id) {
        ...
        if (id == "accionRealizo") {
          $.each(vm.arrayAccionRealizo, function (index, value) {
            estaCheck = $(
              "#wizard-p-2 > div > div:nth-child(" + value + ") > label > div",
            ).hasClass("checked");
            if (estaCheck) {
        ...
        if (id == "proximosPasos") {
          $.each(vm.arrayProximosPasos, function (index, value) {
            estaCheck = $(
              "#wizard-p-3 > div > div:nth-child(" + value + ") > label > div",
            ).hasClass("checked");
            if (estaCheck) {
      ...
      vm.crearBitacoraDeFicha = function () {
        ...
        vm.bitacoraFicha.comentarios =
          "COMPLETAR FICHA -> Se ha editado datos de la ficha del referido.";

        vm.bitacora = new Bitacoras(vm.bitacoraFicha);

        vm.bitacora.referenciaId.prioritario = vm.bitacora.referenciaId
          .prioritario
          ? true
          : false;
        vm.bitacora.referenciaId.referidoId.afp = vm.bitacora.referenciaId
          .referidoId.afp
          ? vm.bitacora.referenciaId.referidoId.afp
          : "";
        vm.bitacora.referenciaId.referidoId.prima = vm.bitacora.referenciaId
          .referidoId.prima
        ...
        vm.bitacora.$save(
          ...
          function (res) {
            ...
            vm.cerrarFicha(function () {
              vm.verificarBloqueo(
                vm.rollUsuario == "usr" || vm.rollUsuario == "ast"
                  ? vm.referenciaSeleccionada
                  : vm.referenciaSeleccionada.id,
              );
            });
          },
          function (err) {
            vm.mostrarLoading = false;
            toastr.error(
              "Ha ocurrido un problema al actualizar la actividad.",
              " " + err.status + " " + err.statusText,
            );
          },
        );
      ...
      vm.actualizarReferenciasSegunFicha = function (res) {
        ...
        vm.referencias.$update(
          ...
          function (err) {
            vm.mostrarLoading = false;
            toastr.error(
              "Ha ocurrido un problema al actualizar las referencias.",
              " " + err.status + " " + err.statusText,
            );
      ...
      vm.guardarFicha2 = function () {
        ...
        vm.continuar5 = function () {
          if (vm.estoyViendoUnaRef) {
            ...
            if (
              vm.ficha.FECHANAC != undefined &&
              vm.ficha.FECHANAC.length > 0
            ) {
            ...
            if (
              vm.ficha.celularReferido != undefined &&
              vm.ficha.celularReferido.length > 0
            ) {
              vm.referenciaSeleccionada.referidoId.telefonos =
                vm.ficha.celularReferido;
            }
            if (
              vm.ficha.celularReferido2 != undefined &&
              vm.ficha.celularReferido2.length > 0
            ) {
              vm.referenciaSeleccionada.referidoId.telefonos2 =
                vm.ficha.celularReferido2;
            }
            if (
              vm.ficha.celularReferido3 != undefined &&
              vm.ficha.celularReferido3.length > 0
            ) {
              vm.referenciaSeleccionada.referidoId.telefonos3 =
                vm.ficha.celularReferido3;
            }
            ...
            vm.referenciaSeleccionada.referidoId.clienteSolicito =
              vm.ficha.clienteSolicito;
            vm.referenciaSeleccionada.referidoId.pensionarse =
              vm.ficha.pensionarse;
            vm.referenciaSeleccionada.referidoId.accionRealizo =
              vm.ficha.accionRealizo;
            vm.referenciaSeleccionada.referidoId.tipoPension =
              vm.ficha.tipoPension;

            ficha = new Referidos(vm.referenciaSeleccionada.referidoId);
          } else {
            ficha = new Referidos();
            ficha.COMENTARIOS =
              "REFERIDO CREADO POR FICHA POR EJECUTIVO(A) -> ";
          }
          ...
          if (vm.rollUsuario == "ast") {
            ...
            if (
              vm.getNombreEjecutiva(vm.usuarioEsAsistenteDe2String) != undefined
            ) {
              ficha.OWNERENAME = vm.getNombreEjecutiva(
                vm.usuarioEsAsistenteDe2String,
              ).nombre;
            }
          }
          ...
          if (vm.estoyViendoUnaRef) {
            ficha.$update(
              ...
              function (err) {
                vm.mostrarLoading = false;
                toastr.error(
                  "Ha ocurrido un problema al actualizar las Ficha.",
                  " " + err.status + " " + err.statusText,
                );
                ...
                if (res.tieneReferenciaActiva == true) {
                  swal("Are you sure?", {
                    ...
                    text:
                      ...
                      " ó " +
                      rut.replace("-", "") +
                      ",   ya tiene una referencia activa.",
                    dangerMode: true,
                  });
                  vm.mostrarLoading = false;
                  return;
      ...
      vm.fichaCanalDigitalGuardarActualizar = function () {
        ...
        angular.forEach(vm.canalDigital, function (f, x) {
          ...
          if (f.respuesta2 != undefined) {
            respuestas = {
              ...
              fechaRespuesta:
                x == 3
                  ? moment(f.respuesta2, "DD/MM/YYYY").format(
        ...
        $http({
          ...
          function (err) {
            vm.mostrarLoading = false;
            toastr.error(
              "Ha ocurrido un problema al guardar las respuestas.",
              " " + err.status + " " + err.statusText,
            );
          },
        );
      ...
      vm.cargarItemsTable = function () {
        ...
        for (x = 1; x <= vm.nFilas; x++) {
          valorCombo = $(
            "#datatableReferidos > tbody > tr:nth-child(" +
              x +
              ") > td.dt-body-center.sorting_1 > div > select",
          ).val();
      ...
      vm.exportarErrorActualizarDatosReferencias = function (xlsRows) {
        ...
        /* File Name */
        var filename =
          "Error_ActualizarDatosReferencias_" +
          $filter("date")(new Date(), "medium") +
          ".xlsx";
        ...
        $http({
          ...
          function (res) {
            ...
            if (vm.ErrorActualizarDatosReferenciasOut.length > 0) {
              vm.exportarErrorActualizarDatosReferencias(
                vm.ErrorActualizarDatosReferenciasOut,
              );
            }
          },
          function (err) {
            ...
            vm.mostrarLoading = false;
            toastr.error(
              "Ha ocurrido un problema al actualizar Referencias.",
              " " + err.status + " " + err.statusText,
            );
          },
        );
      ...
      vm.fActualizarDatosReferidos = function (jsonData) {
        ...
        $http({
          ...
          function (err) {
            ...
            vm.mostrarLoading = false;
            toastr.error(
              "Ha ocurrido un problema al actualizar referidos.",
              " " + err.status + " " + err.statusText,
            );
          },
        );
      ...
      $scope.readdatosrefe = function (workbook) {
        ...
        $scope.$apply(function () {
          try {
            ...
            for (var i = 1; i < jsonData.length; i++) {
              if (jsonData[i] && jsonData[i].ID && jsonData[i].ID.length > 0) {
                $scope.Elements.push(jsonData[i]);
              } else {
                break;
              }
      ...
      vm.fDerivarMasivoList = function () {
        ...
        $http({
          ...
          function (err) {
            ...
            toastr.error(
              "Ha ocurrido un problema al derivar masivamente las referencias.",
              " " + err.status + " " + err.statusText,
            );
            vm.ejecutivosSelect = null;
          },
      ...
      vm.cargarFicha2 = function (ref) {
        if (!vm.estoyViendoUnaRef) {
          ...
          Canales.list(
            ...
            function (err) {
              vm.mostrarLoading = false;
              toastr.error(
                "Ha ocurrido un problema al cargar el catalogo de Canales.",
                " " + err.status + " " + err.statusText,
              );
        ...
        if (ref != undefined) {
          ...
          vm.ficha.FECHANAC = $filter("date")(
            ref.referidoId.fechanac,
            "dd-MM-yyyy",
          );
      ...
      vm.updateBitacora = function (res, fecha, hora) {
        ...
        res.$update(
          ...
          function (err) {
            vm.mostrarLoading = false;
            toastr.error(
              "Ha ocurrido un problema al actualizar Bitacora",
              " " + err.status + " " + err.statusText,
            );
          },
        );
      ...
      vm.eliminarComentario = function (bit) {
        ...
        Bitacoras.delete(
          ...
          function (err) {
            vm.mostrarLoading = false;
            toastr.error(
              "Ha ocurrido un problema al eliminar la bitacora.",
              " " + err.status + " " + err.statusText,
            );
          },
        );
      ...
      vm.editarBitacora = function (fecha, hora) {
        ...
        Bitacoras.get(
          ...
          function (res) {
            ...
            res.comentarios =
              "REAGENDAR -> Actividad reagendada para : " + fecha + " " + hora;
            vm.updateBitacora(res, fecha, hora);
          },
          function (err) {
            vm.mostrarLoading = false;
            toastr.error(
              "Ha ocurrido un problema al cargar la bitacora.",
              " " + err.status + " " + err.statusText,
            );
          },
        );
      ...
      vm.cerrarSinExito = function () {
        ...
        vm.messageActividad.comentarios =
          "SIN EXITO -> " + vm.messageActividad.comentarios;
      ...
      vm.cerrarConExito = function () {
        ...
        vm.messageActividad.comentarios =
          "VENTA EXITOSA -> " + vm.messageActividad.comentarios;
        vm.enviarActividad(1);
      };
      ...
      vm.cerrarMail2Cliente = function () {
        ...
        vm.messageActividad.comentarios =
          "Actividad cerrada, se debe enviar un mail al cliente  al correo -> " +
          vm.mailCliente2Send;
        vm.enviarActividad(1);
      };
      ...
      vm.cerrarDerivar = function () {
        ...
        vm.messageActividad.comentarios =
          "DERIVAR -> Actividad Derivada a ejecutivo : " +
          vm.ejecutivosSelect.nombre +
          ", sucursal : " +
          vm.ejecutivosSelect.sucursalId.nombre;
        // vm.enviarActividad(1);
        vm.derivarMasivoList = [];
        ...
        $http({
          ...
          function (err) {
            vm.mostrarLoading = false;
            toastr.error(
              "Ha ocurrido un problema al derivar la referencia.",
              " " + err.status + " " + err.statusText,
            );
          },
        );
      ...
      vm.actualizarGraficoPorSucursal = function (noRunPanel) {
        if (vm.sucursalesSelectFiltroPanel != "undefined") {
          vm.sucursalesSelectFiltroPanel2 =
            "'" + JSON.parse(vm.sucursalesSelectFiltroPanel).id + "'";
        } else {
          vm.sucursalesSelectFiltroPanel2 = "undefined";
        }
      ...
      vm.actualizarGraficoPorEjecutivo = function (noRunPanel) {
        if (vm.ejecutivosSelectFiltroPanel != undefined) {
          vm.usuarioSupervisaA2String =
            "'" + JSON.parse(vm.ejecutivosSelectFiltroPanel).codigo + "'";
        } else {
          vm.usuarioSupervisaA2String = undefined;
        }
        if (noRunPanel == undefined) {
      ...
      vm.actualizarGraficoPorFecha = function (noRunPanel) {
        vm.anioParamUrlDataTable =
          vm.mesAnioFiltroGraph != null && vm.mesAnioFiltroGraph != ""
            ? vm.mesAnioFiltroGraph.split("-")[0]
            : "undefined";

        if (
          vm.mesAnioFiltroGraph != null &&
          vm.mesAnioFiltroGraph != "" &&
          vm.mesAnioFiltroGraph.split("-")[1] == undefined
        ) {
          vm.mesParamUrlDataTable = "undefined";
        } else {
          vm.mesParamUrlDataTable =
            vm.mesAnioFiltroGraph != null && vm.mesAnioFiltroGraph != ""
              ? vm.mesAnioFiltroGraph.split("-")[1]
              : "undefined";
        }
      ...
      $scope.reagendar = function (v) {
        ...
        vm.messageActividad.comentarios =
          "REAGENDAR -> Actividad reagendada para : " +
          vm.fechaReagendar +
          " " +
          vm.hora;
        vm.enviarActividad(1);
      ...
      vm.listarReferenciasReagendadasTodoEje = function () {
        ReferenciasReagendadas.list(
          ...
          function (err) {
            ...
            toastr.error(
              "Ha ocurrido un problema al cargar las referencias reagendadas todo ejecutiva.",
              " " + err.status + " " + err.statusText,
            );
      ...
      vm.listarReferenciasNoCerradasPendiente = function () {
        ReferenciasNoCerradas.list(
          ...
          function (res) {
            ...
            vm.ReferenciasNoCerradas = $filter("orderBy")(
              vm.ReferenciasNoCerradas,
              ["ordenEstado"],
            );
      ...
      vm.activarTabla = function () {
        vm.comboBox =
          '<div class="input-group" ><select style="width: 140px;">';
      ...
      vm.mostrarActividadesContactos = function (c) {
        ...
        vm.referencias.$update(
          ...
          function (err) {
            vm.mostrarLoading = false;
            toastr.error(
              "Ha ocurrido un problema al bloquear las referencias.",
              " " + err.status + " " + err.statusText,
            );
        ...
        RolesUsuariosNombre.list(
          ...
          function (res) {
            ...
            if (vm.rollUsuario == "ast") {
              ...
              vm.usuarioEsAsistenteDe2String =
                vm.usuarioEsAsistenteDe.toString();
            }
